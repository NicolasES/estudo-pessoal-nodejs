...
app.use(function(req, res, next){
    // habilita requisicoes de dominios diferentes (cross-domain)
    res.setHeader("Access-Control-Allow-Origin", "*"); 

     // quais metodos a origem pode requisitar
    res.setHeader("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE");

    // para que a origin seja capaz de reescrever as propriedades do header do request
